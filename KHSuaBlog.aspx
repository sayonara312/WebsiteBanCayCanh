<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="KHSuaBlog.aspx.cs" Inherits="Website.KHSuaBlog" %>
...
&nbsp;
        ...
        <tr>
            ...
            <td style="height: 38px">
                <asp:TextBox ID="tbNguoiDang" runat="server" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
